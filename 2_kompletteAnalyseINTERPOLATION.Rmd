...
GG0.1 <- ggplot(DS0, aes(Jahr, AnErfFaelle))+geom_line()+ylim(0, 10)+ ggtitle("Entwiklung der Straftaten insgesamt in Deutschland von 2013 bis 2020") +  xlab("Jahre") + ylab("Anzahl der Straftaten insgesamt")
GG0.1
GG0.2 <- ggplot(DS0, aes(Jahr, AnVersuche))+geom_line()+ylim(0, 10)+ ggtitle("Entwiklung der Versuche insgesamtin Deutschland von 2013 bis 2020") +  xlab("Jahre") + ylab("Anzahl der Versuche insgesamt")
GG0.2
...
GG0.3
GG0.4 <- ggplot(DS0, aes(Jahr, AnAufkl))+geom_line()+ylim(0, 10)+ ggtitle("Entwiklung der aufgeklärten Fälle insgesamt in Deutschland von 2013 bis 2020") +  xlab("Jahre") + ylab("Anzahl der aufgeklärten Fälle")
GG0.4
