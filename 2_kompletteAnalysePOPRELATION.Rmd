...
### 3.1 adjust BKA Data
THE LAST ADJUSTMENT IS THE MOST IMPORTANT IN THE WHOLE SCRIPT AND THE MAJOUR DIFFERENCE TO THE OTHER TWO SCRIPTS!!!!
...
```{r}
saveRDS(LF, file="2LF.rds")
saveRDS(LSO, file="2LSO.rds")
```
...
GG0.3
GG0.4 <- ggplot(DS0, aes(Jahr, AnAufkl))+geom_line()+ylim(3000000, 4000000)+ ggtitle("Entwicklung der aufgeklärten Fälle insgesamt in Deutschland") +  xlab("Jahre") + ylab("Anzahl der aufgeklärten Fälle")+theme(plot.title = element_text(size = 14))
GG0.4
...
GG1.1 <- ggplot(DS1.1, aes(x=Jahr, y=AnErfFaelle, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Straftaten insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Anzahl der Straftaten insgesamt")+theme(plot.title = element_text(size = 14))
GG1.1
DS1.2 <- LF%>%filter(Straftat == "Straftaten insgesamt" & Bundesland != "Deut")
GG1.2 <- ggplot(DS1.2, aes(x=Jahr, y=AnErfFaelle, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Straftaten insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Anzahl der Straftaten insgesamt")+theme(plot.title = element_text(size = 14))
GG1.2
GG1.3 <- ggplot(DS1.2, aes(x=Jahr, y=AnErfFaelle, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Straftaten insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Anzahl der Straftaten insgesamt")+theme(plot.title = element_text(size = 14))+ theme(legend.position="bottom")+ scale_colour_discrete(name="Verabschiedung des Gesetzes im Jahr", breaks=c("0", "1", "2","3", "4"),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"))
GG1.3
GG1.4 <- ggplot(DS1.2, aes(x=Jahr, y=AnErfFaelle, colour = TG_KG, group=Bundesland))+ geom_line()  +  xlab("Jahr") + ylab("Anzahl der Straftaten insgesamt") + theme(plot.title = element_text(size = 14)) +scale_colour_manual(values = c('red','gray62','gray62','seagreen3', 'seagreen4'),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"), name="Verabschiedung des Gesetzes im Jahr")+ ggtitle("Entwicklung der Straftaten insgesamt in den Bundesländer")+ theme(legend.position="bottom")
GG1.4 
...
GG7.4<- ggplot(out, aes(x=Jahr, y=AnErfFaelle, colour = IDStraftat, group=IDStraftat))+ geom_line()+ ggtitle("Entwiklung der häufigsten Strafrechtliche Nebengesetze in Deutschland") +  xlab("Jahr") + ylab("Anzahl der Straftaten insgesamt zur Bevölkerungsanzahl ")
GG7.4
```
...
GG2.1 <- ggplot(DS2.1, aes(x=Jahr, y=AnVersuche, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Versuche insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Anzahl der Versuche insgesamt")+theme(plot.title = element_text(size = 14))
GG2.1

DS2.2 <- LF%>%filter(Straftat == "Straftaten insgesamt" & Bundesland != "Deut")
GG2.2 <- ggplot(DS2.2, aes(x=Jahr, y=AnVersuche, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Versuche insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Anzahl der Versuche insgesamt")+theme(plot.title = element_text(size = 14))
GG2.2
GG2.3 <- ggplot(DS2.2, aes(x=Jahr, y=AnVersuche, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Versuche insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Anzahl der Versuche insgesamt")+theme(plot.title = element_text(size = 14))+ theme(legend.position="bottom")+ scale_colour_discrete(name="Verabschiedung des Gesetzes im Jahr", breaks=c("0", "1", "2","3", "4"),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"))
GG2.3
...
GG3.1 <- ggplot(DS3.1, aes(x=Jahr, y=TeilVersuche, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung des Versuchenanteils  in den Bundesländer") +  xlab("Jahr") + ylab("Versuchenanteil insgesamt")+theme(plot.title = element_text(size = 14))
GG3.1

DS3.2 <- LF%>%filter(Straftat == "Straftaten insgesamt" & Bundesland != "Deut")
GG3.2 <- ggplot(DS3.2, aes(x=Jahr, y=TeilVersuche, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung des Versuchenanteils  in den Bundesländer") +  xlab("Jahr") + ylab("Versuchenanteil insgesamt")+theme(plot.title = element_text(size = 14))
GG3.2
GG3.3 <- ggplot(DS3.2, aes(x=Jahr, y=TeilVersuche, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung des Versuchenanteils  in den Bundesländer") +  xlab("Jahr") + ylab("Versuchenanteil insgesamt")+theme(plot.title = element_text(size = 14))+ theme(legend.position="bottom")+ scale_colour_discrete(name="Verabschiedung des Gesetzes im Jahr", breaks=c("0", "1", "2","3", "4"),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"))
GG3.3
GG3.4 <- ggplot(DS3.2, aes(x=Jahr, y=TeilVersuche, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung des Versuchenanteils  in den Bundesländer") +  xlab("Jahr") + ylab("Versuchenanteil insgesamt")+theme(plot.title = element_text(size = 14))+scale_colour_manual(values = c('red','gray62','gray62','seagreen3', 'seagreen4'),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"), name="Verabschiedung des Gesetzes im Jahr")+ theme(legend.position="bottom")
GG3.4
```
...
GG4.1 <- ggplot(DS4.1, aes(x=Jahr, y=AnAufkl, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwiklung der aufgeklärten Fälle insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Anzahl der aufgeklärten Fälle insgesamt")+theme(plot.title = element_text(size = 14))
GG4.1

DS4.2 <- LF%>%filter(Straftat == "Straftaten insgesamt" & Bundesland != "Deut")
GG4.2 <- ggplot(DS4.2, aes(x=Jahr, y=AnAufkl, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der aufgeklärten Fälle insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Zahl der aufgeklärten Fälle insgesamt")+theme(plot.title = element_text(size = 14))
GG4.2
GG4.3 <- ggplot(DS4.2, aes(x=Jahr, y=AnAufkl, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der aufgeklärten Fälle insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Zahl der aufgeklärten Fälle insgesamt")+theme(plot.title = element_text(size = 14))+ theme(legend.position="bottom")+ scale_colour_discrete(name="Verabschiedung des Gesetzes im Jahr", breaks=c("0", "1", "2","3", "4"),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"))
GG4.3
GG4.4 <- ggplot(DS4.2, aes(x=Jahr, y=AnAufkl, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der aufgeklärten Fälle insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Zahl der aufgeklärten Fälle insgesamt")+theme(plot.title = element_text(size = 14))+scale_colour_manual(values = c('red','gray62','gray62','seagreen3', 'seagreen4'),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"), name="Verabschiedung des Gesetzes im Jahr")+  theme(legend.position="bottom")
GG4.4
```
...
GG5.1 <- ggplot(DS5.1, aes(x=Jahr, y=TeilAufkl, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Aufklärungsquote insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Aufklärungsquote insgesamt")+theme(plot.title = element_text(size = 14))
GG5.1

DS5.2 <- LF%>%filter(Straftat == "Straftaten insgesamt" & Bundesland !="Deut")
GG5.2 <- ggplot(DS5.2, aes(x=Jahr, y=TeilAufkl, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Aufklärungsquote insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Aufklärungsquote insgesamt")+theme(plot.title = element_text(size = 14))
GG5.2
GG5.3 <- ggplot(DS5.2, aes(x=Jahr, y=TeilAufkl, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Aufklärungsquote insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Aufklärungsquote insgesamt")+theme(plot.title = element_text(size = 14))+ theme(legend.position="bottom")+ scale_colour_discrete(name="Verabschiedung des Gesetzes im Jahr", breaks=c("0", "1", "2","3", "4"),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"))
GG5.3
GG5.4 <- ggplot(DS5.2, aes(x=Jahr, y=TeilAufkl, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Aufklärungsquote insgesamt in den Bundesländer") +  xlab("Jahr") + ylab("Aufklärungsquote insgesamt")+theme(plot.title = element_text(size = 14))+scale_colour_manual(values = c('red','gray62','gray62','seagreen3', 'seagreen4'),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"), name="Verabschiedung des Gesetzes im Jahr")+  theme(legend.position="bottom")
GG5.4
...
Save the Dataframes
```{r}
saveRDS(BKA, file="2BKA.rds")
saveRDS(SO, file="2SO.rds")
saveRDS(Data, file="2Data.rds")
```
...
```{r}
rm(list = ls())
BKA <- readRDS("2BKA.rds")
SO <- readRDS("2SO.rds")
Data <- readRDS("2Data.rds")
```
