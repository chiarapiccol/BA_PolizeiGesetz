...
GG0.1 <- ggplot(DS0, aes(Jahr, AnErfFaelle))+geom_line()+ylim(4000000, 7000000)+ ggtitle("Entwicklung der Straftaten insgesamt in Deutschland") +  xlab("Jahre") + ylab("Anzahl der Straftaten insgesamt")+theme(plot.title = element_text(size = 14))
GG0.1
GG0.2 <- ggplot(DS0, aes(Jahr, AnVersuche))+geom_line()+ylim(350000, 550000)+ ggtitle("Entwicklung der Versuche insgesamt in Deutschland") +  xlab("Jahre") + ylab("Anzahl der Versuche insgesamt")+theme(plot.title = element_text(size = 14))
GG0.2
GG0.3 <- ggplot(DS0, aes(Jahr, TeilVersuche)) +geom_line()+ylim(0, 10)+ ggtitle("Entwicklung der Versuche insgesamt in Deutschland") +  xlab("Jahre") + ylab("Anteil der Versuche insgesamt")+theme(plot.title = element_text(size = 14))
GG0.3
...
GG0.4
GG0.5 <- ggplot(DS0, aes(Jahr, TeilAufkl)) +geom_line()+ylim(0, 100)+ ggtitle("Entwicklung der aufgeklärten Fälle insgesamt in Deutschland") +  xlab("Jahre") + ylab("Anteil der aufgeklärten Fälle insgesamt")+theme(plot.title = element_text(size = 14))
GG0.5
```
...
GG1.1 <- ggplot(DS1.1, aes(x=Jahr, y=AnErfFaelle, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Straftaten insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Anzahl der Straftaten insgesamt")+theme(plot.title = element_text(size = 14))
GG1.1
DS1.2 <- LF%>%filter(Straftat == "Straftaten insgesamt" & Bundesland != "Deut")
GG1.2 <- ggplot(DS1.2, aes(x=Jahr, y=AnErfFaelle, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Straftaten insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Anzahl der Straftaten insgesamt")+theme(plot.title = element_text(size = 14))
GG1.2
GG1.3 <- ggplot(DS1.2, aes(x=Jahr, y=AnErfFaelle, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Straftaten insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Anzahl der Straftaten insgesamt")+theme(plot.title = element_text(size = 14))+ theme(legend.position="bottom")+ scale_colour_discrete(name="Verabschiedung des Gesetzes im Jahr", breaks=c("0", "1", "2","3", "4"),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"))
GG1.3
GG1.4 <- ggplot(DS1.2, aes(x=Jahr, y=AnErfFaelle, colour = TG_KG, group=Bundesland))+ geom_line()  +  xlab("Jahre") + ylab("Anzahl der Straftaten insgesamt") + theme(plot.title = element_text(size = 14)) +scale_colour_manual(values = c('red','gray62','gray62','seagreen3', 'seagreen4'),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"), name="Verabschiedung des Gesetzes im Jahr")+ ggtitle("Entwicklung der Straftaten insgesamt in den Bundesländer")+ theme(legend.position="bottom")
GG1.4 
...
GG2.1 <- ggplot(DS2.1, aes(x=Jahr, y=AnVersuche, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Versuche insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Anzahl der Versuche insgesamt")+theme(plot.title = element_text(size = 14))
GG2.1

DS2.2 <- LF%>%filter(Straftat == "Straftaten insgesamt" & Bundesland != "Deut")
GG2.2 <- ggplot(DS2.2, aes(x=Jahr, y=AnVersuche, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Versuche insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Anzahl der Versuche insgesamt")+theme(plot.title = element_text(size = 14))
GG2.2
GG2.3 <- ggplot(DS2.2, aes(x=Jahr, y=AnVersuche, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Versuche insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Anzahl der Versuche insgesamt")+theme(plot.title = element_text(size = 14))+ theme(legend.position="bottom")+ scale_colour_discrete(name="Verabschiedung des Gesetzes im Jahr", breaks=c("0", "1", "2","3", "4"),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"))
GG2.3
...
GG3.1 <- ggplot(DS3.1, aes(x=Jahr, y=TeilVersuche, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung des Versuchenanteils  in den Bundesländer") +  xlab("Jahre") + ylab("Versuchenanteil insgesamt")+theme(plot.title = element_text(size = 14))
GG3.1

DS3.2 <- LF%>%filter(Straftat == "Straftaten insgesamt" & Bundesland != "Deut")
GG3.2 <- ggplot(DS3.2, aes(x=Jahr, y=TeilVersuche, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung des Versuchenanteils  in den Bundesländer") +  xlab("Jahre") + ylab("Versuchenanteil insgesamt")+theme(plot.title = element_text(size = 14))
GG3.2
GG3.3 <- ggplot(DS3.2, aes(x=Jahr, y=TeilVersuche, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung des Versuchenanteils  in den Bundesländer") +  xlab("Jahre") + ylab("Versuchenanteil insgesamt")+theme(plot.title = element_text(size = 14))+ theme(legend.position="bottom")+ scale_colour_discrete(name="Verabschiedung des Gesetzes im Jahr", breaks=c("0", "1", "2","3", "4"),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"))
GG3.3
GG3.4 <- ggplot(DS3.2, aes(x=Jahr, y=TeilVersuche, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung des Versuchenanteils  in den Bundesländer") +  xlab("Jahre") + ylab("Versuchenanteil insgesamt")+theme(plot.title = element_text(size = 14))+scale_colour_manual(values = c('red','gray62','gray62','seagreen3', 'seagreen4'),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"), name="Verabschiedung des Gesetzes im Jahr")+ theme(legend.position="bottom")
GG3.4
...
GG4.1 <- ggplot(DS4.1, aes(x=Jahr, y=AnAufkl, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwiklung der aufgeklärten Fälle insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Anzahl der aufgeklärten Fälle insgesamt")+theme(plot.title = element_text(size = 14))
GG4.1

DS4.2 <- LF%>%filter(Straftat == "Straftaten insgesamt" & Bundesland != "Deut")
GG4.2 <- ggplot(DS4.2, aes(x=Jahr, y=AnAufkl, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der aufgeklärten Fälle insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Zahl der aufgeklärten Fälle insgesamt")+theme(plot.title = element_text(size = 14))
GG4.2
GG4.3 <- ggplot(DS4.2, aes(x=Jahr, y=AnAufkl, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der aufgeklärten Fälle insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Zahl der aufgeklärten Fälle insgesamt")+theme(plot.title = element_text(size = 14))+ theme(legend.position="bottom")+ scale_colour_discrete(name="Verabschiedung des Gesetzes im Jahr", breaks=c("0", "1", "2","3", "4"),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"))
GG4.3
GG4.4 <- ggplot(DS4.2, aes(x=Jahr, y=AnAufkl, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der aufgeklärten Fälle insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Zahl der aufgeklärten Fälle insgesamt")+theme(plot.title = element_text(size = 14))+scale_colour_manual(values = c('red','gray62','gray62','seagreen3', 'seagreen4'),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"), name="Verabschiedung des Gesetzes im Jahr")+  theme(legend.position="bottom")
GG4.4
...
GG5.1 <- ggplot(DS5.1, aes(x=Jahr, y=TeilAufkl, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Aufklärungsquote insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Aufklärungsquote insgesamt")+theme(plot.title = element_text(size = 14))
GG5.1

DS5.2 <- LF%>%filter(Straftat == "Straftaten insgesamt" & Bundesland !="Deut")
GG5.2 <- ggplot(DS5.2, aes(x=Jahr, y=TeilAufkl, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Aufklärungsquote insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Aufklärungsquote insgesamt")+theme(plot.title = element_text(size = 14))
GG5.2
GG5.3 <- ggplot(DS5.2, aes(x=Jahr, y=TeilAufkl, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Aufklärungsquote insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Aufklärungsquote insgesamt")+theme(plot.title = element_text(size = 14))+ theme(legend.position="bottom")+ scale_colour_discrete(name="Verabschiedung des Gesetzes im Jahr", breaks=c("0", "1", "2","3", "4"),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"))
GG5.3
GG5.4 <- ggplot(DS5.2, aes(x=Jahr, y=TeilAufkl, colour = TG_KG, group=Bundesland))+ geom_line()+ ggtitle("Entwicklung der Aufklärungsquote insgesamt in den Bundesländer") +  xlab("Jahre") + ylab("Aufklärungsquote insgesamt")+theme(plot.title = element_text(size = 14))+scale_colour_manual(values = c('red','gray62','gray62','seagreen3', 'seagreen4'),labels=c("2018 (Bayern)", "2018", "2019", "2020", "2021"), name="Verabschiedung des Gesetzes im Jahr")+  theme(legend.position="bottom")
GG5.4
...
GG6.2.2 <- ggplot(DS6.2, aes(x=Jahr, y=AnVersuche, colour = StraftatGruppe, group=IDStraftat))+ geom_line()+ggtitle("Entwicklung der Versuche insgesamt in Deutschland") +  xlab("Jahre") + ylab("Anzahl der Vesuche insgesamt ")+theme(plot.title = element_text(size = 14))+scale_colour_discrete(labels=c("Diebstahl", "sonst. Straftatbestände", "Straftaten gegen das Leben", "strafrechtliche Nebengesetze", "Straftaten gegen die persönliche Freiheit", "Straftaten gegen die sexuelle Selbstbestimmung", "Vermögens- und Fälschungsdelikte"), name="Straftatenobergruppen")
GG6.2.2

GG6.2.3 <- ggplot(DS6.2, aes(x=Jahr, y=TeilVersuche, colour = StraftatGruppe, group=IDStraftat))+ geom_line()+ggtitle("Entwicklung des Versuchenanteils insgesamt in Deutschland") +  xlab("Jahre") + ylab("Versuchenanteil insgesamt ")+theme(plot.title = element_text(size = 14))+scale_colour_discrete(labels=c("Diebstahl", "sonst. Straftatbestände", "Straftaten gegen das Leben", "strafrechtliche Nebengesetze", "Straftaten gegen die persönliche Freiheit", "Straftaten gegen die sexuelle Selbstbestimmung", "Vermögens- und Fälschungsdelikte"), name="Straftatenobergruppen")
GG6.2.3

GG6.2.4 <- ggplot(DS6.2, aes(x=Jahr, y=AnAufkl, colour = StraftatGruppe, group=IDStraftat))+ geom_line()+ggtitle("Entwicklung der aufgeklärten Fälle insgesamt in Deutschland") +  xlab("Jahre") + ylab("Anzahl der aufgeklärten Fälle insgesamt ")+theme(plot.title = element_text(size = 14))+scale_colour_discrete(labels=c("Diebstahl", "sonst. Straftatbestände", "Straftaten gegen das Leben", "strafrechtliche Nebengesetze", "Straftaten gegen die persönliche Freiheit", "Straftaten gegen die sexuelle Selbstbestimmung", "Vermögens- und Fälschungsdelikte"), name="Straftatenobergruppen")
GG6.2.4

GG6.2.5 <- ggplot(DS6.2, aes(x=Jahr, y=TeilAufkl, colour = StraftatGruppe, group=IDStraftat))+ geom_line()+ ggtitle("Entwicklung Aufklärungsquote insgesamt in Deutschland") +  xlab("Jahre") + ylab("Aufklärungsquote insgesamt ")+theme(plot.title = element_text(size = 14))+scale_colour_discrete(labels=c("Diebstahl", "sonst. Straftatbestände", "Straftaten gegen das Leben", "strafrechtliche Nebengesetze", "Straftaten gegen die persönliche Freiheit", "Straftaten gegen die sexuelle Selbstbestimmung", "Vermögens- und Fälschungsdelikte"), name="Straftatenobergruppen")
GG6.2.5
...
GG8.1<- ggplot(DS8, aes(x=Jahr, y=AnErfFaelle, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwiklung der Strafrechtliche Nebengesetze in den Bundesländern") +  xlab("Jahre") + ylab("Anzahl der Strafrechtliche Nebengesetze")+theme(plot.title = element_text(size = 14))
GG8.1
### overview on Diebstahl
DS8 <- LF%>%filter(IDStraftat == "****00" & Bundesland != "Deut")
GG8.2<- ggplot(DS8, aes(x=Jahr, y=AnErfFaelle, colour = Bundesland, group=Bundesland))+ geom_line()+ ggtitle("Entwiklung von Diebstahl in den Bundesländern") +  xlab("Jahre") + ylab("Anzahl der Diebstahle")+theme(plot.title = element_text(size = 14))
GG8.2
...
plot1.1<- path.plot(synth.res = synth.outAnFaelle,
...
plot1.2<-gaps.plot(synth.res = synth.outAnFaelle,
           dataprep.res = dataprep.outAnFaelle,
           Ylab = "Anazhl der Straftaten Insgesamt",
           Xlab = "Jahr",
           Main = NA
...
#path plot
plot1.3 <-path.plot(synth.res = synth.outAnFaellePLACEBO,
...
plot2.1<-path.plot(synth.res = synth.outAnVers,
...
plot2.2<-gaps.plot(synth.res = synth.outAnVers,
           dataprep.res = dataprep.outAnVers,
           Ylab = "Anazhl der Versuche der Straftaten Insgesamt",
           Xlab = "Jahr",
           Main = NA
...
#path plot
plot2.3<-path.plot(synth.res = synth.outAnFaellePLACEBO,
           dataprep.res = dataprep.outAnFaellePLACEBO,
           Ylab = "Anazhl der Straftaten Insgesamt",
           Xlab = "Jahr",
           Legend = c("Bayern","synthetic Bayern"),
...
plot3.1<-path.plot(synth.res = synth.outTeilVers,
...
plot3.2<-gaps.plot(synth.res = synth.outTeilVers,
           dataprep.res = dataprep.outTeilVers,
           Ylab = "Teil der Versuche der Straftaten Insgesamt",
           Xlab = "Jahr",
           Main = NA
...
#path plot
plot3.3<-path.plot(synth.res = synth.outAnFaellePLACEBO,
           dataprep.res = dataprep.outAnFaellePLACEBO,
           Ylab = "Anazhl der Straftaten Insgesamt",
           Xlab = "Jahr",
           Legend = c("Bayern","synthetic Bayern"),
...
plot4.1<-path.plot(synth.res = synth.outAnErkl,
...
plot4.2<-gaps.plot(synth.res = synth.outAnErkl,
           dataprep.res = dataprep.outAnErkl,
           Ylab = "Anazhl der Straftaten Insgesamt",
           Xlab = "Jahr",
           Main = NA
...
#path plot
plot4.3<-path.plot(synth.res = synth.outAnFaellePLACEBO,
           dataprep.res = dataprep.outAnFaellePLACEBO,
           Ylab = "Anazhl der Straftaten Insgesamt",
           Xlab = "Jahr",
           Legend = c("Bayern","synthetic Bayern"),
...
plot5.1<-path.plot(synth.res = synth.outTeilAufk,
...
plot5.2<-gaps.plot(synth.res = synth.outTeilAufk,
           dataprep.res = dataprep.outTeilAufk,
           Ylab = "Teil der aufgeklärten Straftaten Insgesamt",
           Xlab = "Jahr",
           Main = NA
...
#path plot
plot5.3<-path.plot(synth.res = synth.outAnFaellePLACEBO,
           dataprep.res = dataprep.outAnFaellePLACEBO,
           Ylab = "Anazhl der Straftaten Insgesamt",
           Xlab = "Jahr",
           Legend = c("Bayern","synthetic Bayern"),
